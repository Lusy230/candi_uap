...
class BlocProvider<T extends BlocBase> extends StatefulWidget {
  ...
  static T? of<T extends BlocBase>(BuildContext context){
    ...
    _BlocProviderInherited<T>? provider = context.getElementForInheritedWidgetOfExactType as _BlocProviderInherited<T>?;
...
_BuildWithChild blocTreeNode<T extends BlocBase>(T bloc) =>
    (Widget child) => BlocProvider<T>(bloc: bloc, key: UniqueKey(),
    child: child);