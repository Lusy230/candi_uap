...
import 'package:candi_uap/controllers/game_controller.dart';
import 'package:candi_uap/helpers/array_2d.dart';
import 'package:candi_uap/models/animation_sequence.dart';
import 'package:candi_uap/models/avalanche_test.dart';
import 'package:candi_uap/models/chain.dart';
...
import 'package:candi_uap/models/tile_animation.dart';
...
//Stopwatch stopwatch = new Stopwatch()..start();    
      ...
      //
      _state = Array2d<int>(rows, cols, defaultValue: 0);
        ...
        combo.tiles.forEach((Tile tile){
          ...
          _registerAnimation(
              ...
              TileAnimation(
                  ...
                  from: from,
                  to: rowCol,
                  tile: _tiles[tile.row][tile.col], tileType: null,
              ),
          );
