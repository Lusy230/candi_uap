...
class Board extends StatelessWidget {
  ...
  late Array2d<BoxDecoration> _decorations;
  late Array2d<Color> _checker;
  ...
  void _buildDecorations() {
    ...
    _decorations = Array2d<BoxDecoration>(cols + 1, rows + 1, defaultValue: const BoxDecoration());
  ...
  void _buildChecker(){
    ...
    _checker = Array2d<Color>(rows, cols, defaultValue: Colors.white);
    int counter = 0;
  ...
  void _afterBuild() {
    ...
    if (_keyChecker.currentContext != null){
      final Rect rectBoard = _getDimensionsFromContext(_keyChecker as BuildContext);
      ...
      //
      final Rect rectBoardSquare = _getDimensionsFromContext(_keyChecker as BuildContext);
