...
import 'package:candi_uap/widget/double_curved_container.dart';
import 'package:candi_uap/widget/objective_item.dart';
import 'package:flutter/material.dart';

// Ensure the following imports are correct for your application
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> objectiveWidgets =
      ...
      return Padding(
        ...
        child: ObjectiveItem(objective: obj, level: widget.level, key: UniqueKey()),
      );
    }).toList();
    ...
    return AnimatedBuilder(
      ...
      child: Material(
        ...
        child: DoubleCurvedContainer(
          ...
          height: 150.0,
          outerColor: const Color.fromRGBO(25, 118, 210, 1),
